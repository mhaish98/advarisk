...
state_ids = [{17:[1128,1138,1147,1157,1159]}]

state_codes =[{"OR":"or_satbara"}]
...
excel_filename = str(custom_directory) + "responses_random_OR_" + str(datetime.now().strftime('%Y%m%d_%H%M%S')) + ".xlsx"
