...
base_callback_url = "https://webhook.advarisk.com/webhook/30/"
...
def get_callback_url():
    current_time = datetime.now().strftime("%Y%m%d%H%M%S%f")[:-3]
    callback_url = f"https://webhook.advarisk.com/webhook/30/{current_time}"
    return callback_url
...
{  # 17_1
    ...
    {  #DATA_NOT_AVAILABLE_FOR_SEARCHTERM_IN_WEBSITE
        "order_id": "ORD435776987",
        "target_scraper": "mp_satbara_v2",
        "search_attributes": {
            "district_code": "23",
...
excel_file_path = "/home/maheshshingade/Scraping_output/Daily_Sanity_As_is.xlsx"
...
custom_directory = "/home/maheshshingade/Scraping_output"
#custom_directory = "/home/user/Data/Scraping_API/Daily_Sanity/"

excel_filename = str(custom_directory) + "responses_dev_percent_Live_" + str(datetime.now().strftime('%Y%m%d_%H%M%S')) + ".xlsx"
...
zulip_topic_name = "Scraping_API_Automation_Testing"
zulip_email = "mahesh.shingade@advarisk.com"
zulip_api_key = "4u1MgZTsePASkGRGwrwbru1JZ4cWdssG"
