...
state_ids = [{3:[91,96,104,120,113]}] # Replace with your state IDs

state_codes =[{"RJ":"rj_bhunaksha"}]
...
excel_filename = str(custom_directory) + "responses_random_RJ_bhunaksha_" + str(datetime.now().strftime('%Y%m%d_%H%M%S')) + ".xlsx"
