...
response_filename = f"responses_stage_percent_{current_date}.json"
...
excel_filename = str(custom_directory) + "responses_stage_percent_" + str(datetime.now().strftime('%Y%m%d_%H%M%S')) + ".xlsx"
